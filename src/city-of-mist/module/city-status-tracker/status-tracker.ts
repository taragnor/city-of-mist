...
export class StatusTracker {
	...
	static pc_alpha_sort(this: void, a: TrackerItem, b: TrackerItem) {
		return StatusTracker.pc_type_sort(a,b)
			|| StatusTracker.alpha_sort(a, b);
	}

	static alpha_sort(this: void, a: TrackerItem, b: TrackerItem) {
		if (a.name < b.name)
			{return -1;}
		if (a.name > b.name)
			{return 1;}
	...
	static tag_sort(this: void, a: TrackerItem, b: TrackerItem) {
